...
\begin{enumerate}
    \item Speed. In a real time path tracer, rendering speed is of utmost importance as one needs
...
\begin{description}
    \item[Random number generation] rofl
    \item[omg] was
\end{description}
...
the cone that rays will be generated inside of.\label{lst:trac0r-hemisphere-sampling}}
...
\begin{figure}[H]
    ...
    \subfloat[\(n = 50\)]{\includegraphics[scale=0.15]{trac0r-50.png}}
    \subfloat[\(n = 100\)]{\includegraphics[scale=0.15]{trac0r-100.png}}
    \centering
...
\begin{tikzpicture}
    \begin{axis}[
        ...
        \addplot+[
            ...
            coordinates {
                (2006,518) [\tiny NVIDIA Geforce 8800 GTX]
                (2008,933) [\tiny NVIDIA Geforce GTX 280]
                (2010,1088) [\tiny NVIDIA Geforce GTX 470]
                (2010,1405) [\tiny NVIDIA Geforce GTX 570]
                (2013,5046) [\tiny NVIDIA Geforce GTX 780 Ti]
                (2013,4848) [\tiny AMD R9 290]
                (2012,1881) [\tiny NVIDIA Geforce GTX 660]
                (2015,2308) [\tiny NVIDIA Geforce GTX 960]
                (2014,3494) [\tiny NVIDIA Geforce GTX 970]
                (2014,4612) [\tiny NVIDIA Geforce GTX 980]
            };
...
\listoffigures
\listoflistings
% \listoftables I don't have any tables yet
\bibliography{main}
