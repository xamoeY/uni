...
second. For generating random numbers, it uses \texttt{xorshift*} generators.
...
\end{minted}
\captionof{listing}{Russian roulette in trac0r
\ref{lst:trac0r-russian-roulette}\label{lst:trac0r-russian-roulette}}
