...
\ac{aabb}. The fast Möller–Trumbore intersection algorithm \cite{wiki:moller-trumbore} is used for
...
against itself in different scene and hardware configurations. Secondly, \ac{fps} is a much easier
...
\addplot+[
    ...
    coordinates {
        (2010,1405) [\tiny NVDIA Geforce GTX 570]
        (2013,5046) [\tiny NVDIA Geforce GTX 780 Ti]
        (2013,4848) [\tiny AMD R9 290]
        (2014,3494) [\tiny NVDIA Geforce GTX 970]
    };
    \legend{GPUs}
\end{axis}
\end{tikzpicture}
