...
This way, it is possible to determine the total worst number of scene lookups required per image. In the worst
case, no ray exits before reaching its maximum depth. The resulting formula is:
...
triangles
would have \[1920 \times 1080 \times 30 \times 5 \times 5000 \approx \num{1555200000000}
(\SI{1.6}{T} rays)\] rays per frame. % TODO das ist quatsch das hier muss ops sein nicht rays ach
...
\[ Out_w \times Out_h \times s \times d \times \log n \]
