...
\begin{table}[H]
    \centering
    \vtablecalc[2]{\(n\)}{n=10, 100, 1000, 10000, 100000, 1000000}
                  {\(O(n)\)}{n}
...
%     \centering
%     \begin{tabular}{l | r | r}
%         Triangles           & \(O(n)\)      & \(O(\log(n))\) \\ \hline
%         10                  & 10             & 
%         \foreach \n in {0,10,100,1000,10000,100000,1000000}{\n & 8.3           & 1881.6 \\}
%     \end{tabular}
%     \caption{herp}
%     \label{tbl:triangle-intersections-count}
% \end{table}
...
The camera is configured during the scene setup and after % TODO
...
through all triangles. It is therefore interesting to see a decrease that is much % TODO
