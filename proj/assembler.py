...
def parse_line(line):
    ...
    if opcode == "stop":
        ...
        code2 += get_register_bitstring("tmp1")
        code2 = mcode.ljust(INSTRUCTION_SIZE, "0")
        code3 = get_opcode_bitstring("mov")
        code3 += get_register_bitstring("tmp2")
        code3 += get_register_bitstring(instruction[2])
        code4 = get_opcode_bitstring("not")
        code4 += get_register_bitstring("tmp2")
        code4 = mcode.ljust(INSTRUCTION_SIZE, "0")
        code5 = get_opcode_bitstring("and")
        code5 += get_register_bitstring("tmp1")
        code5 += get_register_bitstring(instruction[2])
        code6 = get_opcode_bitstring("and")
        code6 += get_register_bitstring("tmp2")
        code6 += get_register_bitstring(instruction[2])
        code7 = get_opcode_bitstring("or")
        code7 += get_register_bitstring("tmp1")
        code7 += get_register_bitstring("tmp2")
        code8 = get_opcode_bitstring("mov")
        code8 += get_register_bitstring(instruction[1])
        code8 += get_register_bitstring("tmp1")
        mcodes.append(code1)
        mcodes.append(code2)
        mcodes.append(code3)
        mcodes.append(code4)
