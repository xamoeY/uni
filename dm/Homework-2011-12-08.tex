...
\item
$\pi = (1,6)(1,7)(2,13)(2,11)(2,5)(2,8)(2,10)(3,4)(9,12)$
\item
$sign~\pi = -1$
\end{enumerate}
\item[\textbf{4.}]
...
$A \times B \times C = |A \times B \times C|=|A|\cdot |B|\cdot |C| = 3 \cdot 5 \cdot 2 = 30$
\item
Eine n-elementige Menge hat $2^n$ Teilmengen. Es gibt also $2^{30}-1$ Relationen, da $\emptyset$ keine ternäre Relation ist.
\end{enumerate}
%Ende aller Aufgaben
\end{enumerate}
\end{document}
